...
describe('http-client', () => {
    ...
    it('throws helpful error when neither HTTP injection nor injected port present', async () => {
        ...
        // @ts-ignore
        delete globalThis.__SIMPLE_FAKE_API_CONFIG__;
        expect(() => create('missing')).toThrow('simple-fake-api/http: no configuration provided. Provide build-time config via setupSimpleFakeApiHttpRoutes in your bundler or inject __SIMPLE_FAKE_API_HTTP__');
    });
